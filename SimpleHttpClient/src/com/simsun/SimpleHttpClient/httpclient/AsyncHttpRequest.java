	...
	private void makeRequest() throws IOException {
		if (!Thread.currentThread().isInterrupted()) {
			try {
                ...
                Log.e(AsyncHttpClient.TAG, "[makeRequest]IOException:" + e);
				if (!Thread.currentThread().isInterrupted()) {
					throw e;
				}
			}
	...
	private void makeRequestWithRetries() throws ConnectException {
		...
		while (retry) {
			try {
                ...
                Log.e(AsyncHttpClient.TAG, "[makeRequestWithRetries]IOException:" + e);
                ...
                Log.e(AsyncHttpClient.TAG, "[makeRequestWithRetries]NullPointerException:" + e);
        ...
        Log.e(AsyncHttpClient.TAG, "[makeRequestWithRetries] end function. Execption:" + ex);
